...
public class Bullet3 : MonoBehaviour
{
    ...
    {
        if ((collision.gameObject.CompareTag("Teren") || collision.gameObject.CompareTag("Ceiling") || collision.gameObject.CompareTag("Boss") || collision.gameObject.CompareTag("Enemy") || collision.gameObject.CompareTag("Przeszkoda") || collision.gameObject.CompareTag("Default"))   && !isDestroying)
        {
