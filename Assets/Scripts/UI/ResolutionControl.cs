...
public class ResolutionControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < filteredResolutions.Count; i++)
        {
            ...
            if (filteredResolutions[i].width == Screen.width && filteredResolutions[i].height == Screen.height && (float)filteredResolutions[i].refreshRateRatio.value == currentRefreshRate) // double'dan float'a dönüºtürüldü
            {
